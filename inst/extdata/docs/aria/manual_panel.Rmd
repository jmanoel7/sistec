...
- Utilizando os Filtros de Pesquisa:
    -  Selecione o campus
    -  Selecione o "Ano de Ingresso a Partir de:"
    -  Em exibição marque as opções: Campus, CPF, Data de Matrícula, Descrição do Curso, Forma de Ingresso e Situação no Curso; 
    -  Clique em pesquisar.
